        ...
        <div class="row ">
            <div class="col-xs-12">
                ...
                <div class="new">
                    ...
                    <p class="description">
                        Автор: ${aboutNews.author.username} ${aboutNews.dateOfCreation}
                    </p>
                    ...
                    <div class="col-sm-8">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <strong>${item.author.username}</strong> <span class="text-muted">добавлено ${item.dateOfCreation}</span>
                            </div>
